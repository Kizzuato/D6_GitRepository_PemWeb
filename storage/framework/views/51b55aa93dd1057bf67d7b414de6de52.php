    ...
    <div class="container-fluid hero-section">
        ...
        <div class="row w-100 align-items-center">
            ...
            <div class="col-lg-5 ps-lg-5 hero-text position-relative" style="z-index: 5;">
                ...
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-mulai">Mulai</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-mulai">Mulai</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            ...
            <div class="col-lg-7 rover-container">
                ...
                <img src="<?php echo e(asset('assets/img/2 1.png')); ?>" class="rover-img" alt="Forte Rover">
            </div>
...
<?php /**PATH /home/kizzuato/Projects/i-will/rover/pemdas/forte-frontend/resources/views/lp-awal.blade.php ENDPATH**/ ?>