        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end">
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link btn-daftar-nav" href="<?php echo e(route('register')); ?>">Daftar</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="register-section">
        ...
        <div class="register-card">
            <form action="#" method="POST">
                ...
                <div class="mb-2">
                    <label>Email</label>
                    <input type="email" class="form-control form-control-forte" placeholder="">
                </div>

                <div class="mb-2">
                    <label>Password</label>
                    <div class="position-relative">
                        <input type="password" class="form-control form-control-forte">
        ...
        <div class="rover-container">
            <img src="<?php echo e(asset('assets/img/2 1.png')); ?>" class="rover-placeholder" alt="Forte Rover">
        </div>
...
<?php /**PATH /home/kizzuato/Projects/i-will/rover/pemdas/forte-frontend/resources/views/login/form_register.blade.php ENDPATH**/ ?>