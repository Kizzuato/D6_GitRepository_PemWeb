        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex gap-2 align-items-center">
            ...
            <div class="input-group input-group-sm border-secondary" style="width: 200px;">
                <span class="input-group-text bg-transparent text-white border-secondary"><i class="fas fa-search"></i></span>
                <input type="text" class="form-control bg-transparent text-white border-secondary" placeholder="Search...">
            </div>

            {{-- Show Entries --}}
            <div class="d-flex align-items-center text-xs text-white gap-2 ms-2">
                <span>Show</span>
                <select class="form-select form-select-sm bg-dark text-white border-secondary" style="width: 65px;">
                    <option>10</option>
                </select>
                <span>entries</span>
            </div>
            ...
            {{-- Date Filter --}}
            <select class="form-select form-select-sm bg-dark text-white border-white ms-2" style="border-radius: 8px; width: 180px;">
      ...
      <div class="card-body px-0 pt-0 pb-2 mt-4">
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0" style="border-collapse: collapse;">
            <thead>
              <tr class="border-0">
                <th class="text-uppercase text-xxs font-weight-bolder text-white ps-4 text-center">ID Sensor</th>
                <th class="text-uppercase text-xxs font-weight-bolder text-white text-center">Lintang</th>
                ...
                <th class="text-uppercase text-xxs font-weight-bolder text-white text-center">Anomali</th>
            ...
            <tbody class="border-0">
              ...
              <tr style="background-color: #14451a; border: none;">
                ...
                <td class="text-center text-sm text-white">pohon tumbang</td>
                <td class="text-center text-sm text-white px-2">ada penghalang jalan pohon yang tumbang di.....</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <nav>
            <ul class="pagination pagination-sm mb-0">
              <li class="page-item active">
                <a class="page-link border-1 border-success bg-transparent" style="border-radius: 8px; color: #4caf50;">1</a>
              </li>
              <li class="page-item ms-2"><a class="page-link bg-transparent border-0 text-white">2</a></li>
              <li class="page-item ms-2"><a class="page-link bg-transparent border-0 text-white">3</a></li>
            </ul>
          </nav>
